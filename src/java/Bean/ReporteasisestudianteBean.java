...
@ManagedBean
@RequestScoped
public class ReporteasisestudianteBean {
    ...
    public List<Aulaperiodo> getLstaulaperiodo() {
        lstaulaperiodo=controlador.findAulaperiodoEntities();
    ...
    private String dni="";
    /**
     * Creates a new instance of ReporteasisestudianteBean
     */
    public ReporteasisestudianteBean() {
    }
    ...
    /////////////////IREPORT
		...
		parametros.put("dni", dni);
                parametros.put("idauulaperiodo", idaulaperiodo);
		
		File jasper = new File(FacesContext.getCurrentInstance().getExternalContext().getRealPath("/reportes/ReportAasistenciaestudiante.jasper"));
