...
@ManagedBean
@RequestScoped
public class AsistenciadocBean {
...
EntityManager em = emf.createEntityManager();
    ...
    public void registrarasistencia()
    {
        ...
        StoredProcedureQuery storedProcedure=em.createStoredProcedureQuery("SPmarcarasistenciadocentes");
        ...
        if (salida.equals("no encontrado"))
                {
                    FacesMessages.error("Lo sentimos no se ah encontrado su horario");
                }
        else
        {
